...
- Building **AI-powered solutions** at [Betalyra](https://betalyra.com/), a company focused on **optimizing business processes through artificial intelligence** and **agentic workflows**.
- Designing and implementing **autonomous AI agents** that execute complex, multi-step tasks with minimal human intervention, enabling smarter and more adaptive business operations.
...
- Developing **modern React applications** with **Next.js**, integrating multiple **AI SDKs** (OpenAI, Anthropic, Vercel AI SDK) to deliver intelligent user experiences.
- Contributing to the architecture of **scalable AI pipelines** that transform how businesses approach automation and decision-making.
...
- Deepened my expertise in **Nix** for infrastructure management within an **event-based architecture** deployed on **Google Cloud Platform (GCP)**.
...
- Leveraged **AWS services**, specially **Lambdas**, for scalable and efficient backend operations.
...
- **Architected** a robust configuration management system for probes, ensuring **backward compatibility** for legacy components while presenting a **unified interface** through an **adapter architecture**.
...
- Proactively created a system to **automate the shift handover**, accessible via a centralized UI. It become the team standard.
...
- **Increased the productivity of the team** by creating  and documenting a library of scripts in **VBScript** for the most sensitive and complex tasks (due to their complexity or number of parameters).
...
- Deep interest in Domain Driven Design (DDD)
...
- Programming Languages: **TypeScript**, Rust, OCaml, Python
- Scripting Languages: Bash, Lua, Google Apps Script, VBScript
